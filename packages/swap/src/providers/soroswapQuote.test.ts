...
import { normalizePoolHashForBuild, normalizeSoroswapQuoteForBuild } from './soroswapQuote'

describe('normalizePoolHashForBuild', () => {
  ...
  it('leaves valid Base64 pool hashes unchanged', () => {
...
describe('normalizeSoroswapQuoteForBuild', () => {
  it('rewrites hex poolHashes inside rawTrade.distribution', () => {
    ...
    expect(
      (quote.rawTrade.distribution[0].poolHashes as string[])[0]
    ).toBe('b2e02fcfca6c96f8ad5cbd84e7784a777b36d9c96a2459402c4f458462aab7f0')
  })
})
