...
import passkeySuccessUrl from 'url:../../../assets/onboarding/web/passkey-success.svg'

export function OnboardingPasskeySuccessCard({
  onClose,
  onGoToDashboard,
}: {
  onClose: () => void
      ...
      <div className="flex min-h-0 flex-1 flex-col items-center justify-center">
        <div className="flex min-h-0 w-full flex-1 flex-col items-center justify-between">
          ...
          <button
            ...
            className="relative flex h-[50px] w-full shrink-0 items-center justify-center overflow-hidden rounded-[32px] border border-[#f0a300] px-5 py-3 text-[18px] font-semibold leading-[1.31] tracking-[-0.18px] text-[#121212] shadow-[0px_12px_13.1px_-8px_rgba(246,139,7,0.1)]"
          >
            <span
              aria-hidden
              className="pointer-events-none absolute inset-0 rounded-[32px] bg-[#ffad00]"
            />
            <span className="relative whitespace-nowrap">Go to Dashboard</span>
            <span
              aria-hidden
