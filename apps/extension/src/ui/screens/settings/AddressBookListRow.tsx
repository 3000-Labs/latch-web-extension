...
import type { AddressBookEntry } from '../send/useAddressBook'

export function AddressBookListRow({ entry }: { entry: AddressBookEntry }) {
  return (
    <div className="flex w-full items-center rounded-[14px] py-1">
